...
export default function ClosingCta() {
  ...
  return (
    ...
    >
      <div style={{ position: "absolute", bottom: -220, left: "50%", transform: "translateX(-50%)", width: 900, height: 520, borderRadius: "50%", background: "radial-gradient(circle,rgba(124,77,204,0.24),transparent 70%)", filter: "blur(80px)", pointerEvents: "none", animation: "seqnc-drift 16s ease-in-out infinite" }} />
