  ...
  return (
    ...
    >
      ...
      <Reveal style={{ position: "relative", maxWidth: 820, margin: "0 auto", padding: "clamp(80px,9vw,132px) 32px", textAlign: "center" }}>
        <h2 style={{ fontFamily: display, fontSize: "clamp(32px,4.4vw,58px)", lineHeight: 1.02, letterSpacing: "-0.035em", fontWeight: 800, margin: "0 0 20px", textWrap: "balance" as never }}>{t.closing.title}</h2>
